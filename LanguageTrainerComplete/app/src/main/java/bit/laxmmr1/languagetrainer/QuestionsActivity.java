...
public class QuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonNextQuestion.setOnClickListener(new NextQuestionClickHandler());
           ...
           if (check == true)
            {
               currentQuestion++;
                if (currentQuestion < images.length)
                {
                    ...
                    {
                        ButtonNextQuestion.setText("Show Result");
                    }
                }else
                {
                    //LastQuestion Button Will launch the Feedback activity
    ...
    //=======================================================NEED METHOD TO DISPLAY SCORE ON THE LAST PAGE!==============================================================
} //End Main Class
